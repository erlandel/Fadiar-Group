...
const filteredProducts = useMemo(() => {
  ...
  return filtered;
}, [allProducts, category, brands, price,priceRange]);
    ...
    return(
        <main className="flex w-full h-auto flex-col">
            ...
            <div id="content" className="w-full mb-20  xl:w-4/5 overflow-hidden">
                ...
                <div className="hidden xl:block">
                  <Pot/>
                   ...
                   <div id="list" className="mt-20 px-4 md:px-0 flex w-full justify-between items-center">
                      ...
                      {(category.length > 0 || brands.length > 0 || price[0] !== 0 || price[1] !== 200) && (
                ...
                <div  className="mt-20 mx-5 lg:mx-0 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 lg:mt-0 xl:grid-cols-4 2xl:grid-cols-5 gap-4 xl:mr-20 auto-rows-fr">
                  {isLoading ? (
                ...
                {totalPages > 0 && (
                  <div className="flex justify-center my-10">
                    <Pagination 
                      ...
                      onPageChange={(page) => {
                        setCurrentPage(page);
                        // Scroll al elemento list cuando cambia la página
