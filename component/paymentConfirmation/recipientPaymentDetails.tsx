      ...
      <div className="space-y-3 mt-4 ">
        ...
        <div className="ml-4">
          <p className="text-[gray] ">
            Método de entrega:{" "}
            <span className="text-primary break-all">{delivery ? "Domicilio" : "Recogida en tienda"}</span>
          </p>
        </div>
        ...
        <div className="ml-4">
          <p className="text-[gray] ">
            Nombre:{" "}
            <span className="text-primary break-all">{beneficiaryDetails.firstName}</span>
          </p>
        </div>
          ...
          <p className="text-[gray] ">
            Apellidos:{" "}
            <span className="text-primary break-all">{beneficiaryDetails.lastName}</span>
          </p>
        </div>
          ...
          <p className="text-[gray] ">
            Teléfono:{" "}
            <span className="text-primary break-all">{beneficiaryDetails.phoneCountry} {beneficiaryDetails.phoneValue}</span>
          </p>
        </div>
          ...
          <p className="text-[gray] ">
            Correo electrónico: {" "}
            <span className="text-primary break-all">{beneficiaryDetails.email}</span>
          </p>
          ...
          <p className="text-[gray] ">
            Dirección: {" "}
            <span className="text-primary break-all">{beneficiaryDetails.address}</span>
          </p>
        </div> 
